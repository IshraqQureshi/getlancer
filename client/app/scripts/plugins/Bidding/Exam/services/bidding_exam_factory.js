...
angular.module('getlancerApp.Bidding.Exam')
    .factory('Exams', ['$resource', function($resource) {
        return $resource('http://localhost:8080/api/v1/exams', {}, {
            get: {
                method: 'GET'
            }
        });
    ...
    .factory('ExamsView', ['$resource', function($resource) {
        return $resource('http://localhost:8080/api/v1/exams/:id', {}, {
            get: {
                method: 'GET'
            }
        });
    ...
    .factory('ExamStart', ['$resource', function($resource) {
        return $resource('http://localhost:8080/api/v1/exams_users/:id', {}, {
            get: {
                method: 'GET'
            }
        });
    ...
    .factory('MyExam', ['$resource', function($resource) {
        return $resource('http://localhost:8080/api/v1/me/exams_users', {}, {
            get: {
                method: 'GET'
            }
        });
    ...
    .factory('QuestionAnswer', ['$resource', function($resource) {
        return $resource('http://localhost:8080/api/v1/exam_answers', {}, {
            post: {
                method: 'POST'
            }
        });
